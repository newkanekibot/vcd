...
async def reply(client, message): 
    try:
        ...
        await message.reply(f"{Config.REPLY_MESSAGE}\n\n<b>You can't use this bot in your group, for that you have to make your own bot from the [PLZ GIVE ME](https://youtube.com/channel/UCUw4ZmMC_H2SYdcka9teJ7A) below.</b>", disable_web_page_preview=True)
