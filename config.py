...
class Config:
    #Telegram API Stuffs
    load_dotenv("config.env")  # load enviroment variables from .env file
...
Command: **/yplay**
__First get a playlist file from @arnavsinghilex or @OP_ARNAV_SINGH and reply to playlist file.__
...
__Example: To set up a__ `REPLY_MESSAGE` __use__ `/env REPLY_MESSAGE=Hey, Check out @ilexupdates rather than spamming in my PM`__
...
4. `SESSION_STRING` : __Generate From here [GenerateStringName](https://t.me/StringSessionGene_bot)__
...
You can also use YouTube Playlist.Find a Telegram Link for your playlist from [PlayList Dumb](https://youtube.com/@arnavsingh143) or get a PlayList from [PlayList Extract](https://youtube.com/@arnavsingh143). 
The PlayList link should in form `https://youtube.com/@arnavsingh143`
